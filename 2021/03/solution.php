<?php
    ...
    return static function (string $input): array {
         ...
         * @return string
         */
        $getBitsAtOffset = function ( array $input, int $number ): string {
...
//        ] );
        ...
        return [
            'part1' => bindec( $p1['epsilon'] ) * bindec( $p1['gamma'] ),
            'part2' => bindec( current( $filterList['co2'] ) ?: ''  ) * bindec( current( $filterList['o2'] ) ?: ''  ),
        ];
    };
